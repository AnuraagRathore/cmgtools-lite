...
PBASE="plots/104X/${ANALYSIS}/lepMVA/v7.0/fr-meas/qcd1l/$lepdir/$YEAR/HLT_$trigger/$what/$more"
...
case $what in
	...
	XVAR="ptJI90_mvaPt0${MVAWP}_coarselongbin"
		...
		echo "( $STACK -o $PBASE/fr_sub_eta_${E}_compH.root    $PBASE/fr_sub_eta_${E}_fitGlobalSimND.root:$PATT:${QCD}_red_prefit,data_fit $PBASE/fr_sub_eta_${E}_fitGlobalSemiParND.root:$PATT:data_fit --comp-style fitcomp  )";
