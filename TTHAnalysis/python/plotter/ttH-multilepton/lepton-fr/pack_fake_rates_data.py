...
if __name__ == "__main__":
    ...
    parser.add_option("--mva-version",  dest="mvaVersion",  default="v7.0",  type="string", help="MVA version (common)")
	...
	"""
        ...
        MCPlots = "plots/run3/ttH/lepMVA/v1.1/fr-mc/%s" % year
	ID="iRun3v1.0f60E3";
	#ID="iv01f60E3";
	#ID="iRun3v3.0";
